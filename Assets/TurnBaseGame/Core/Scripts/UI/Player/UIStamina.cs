...
public class UIStamina : UIDataItem<PlayerStamina>
{
    ...
    private void SetupInfo(PlayerStamina data)
    {
        ...
        //Debug.Log("aaaaaaaaaaaaa tempMaxStamina : " + tempMaxStamina);

        if (textAmount != null && tempMaxStamina != 0)
            textAmount.text = data.Amount.ToString("N0") + "/" + tempMaxStamina.ToString("N0");
